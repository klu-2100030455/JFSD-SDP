...
<head>
  ...
  <link rel="stylesheet" href="/css/faculty_css/uploadMaterial.css">
...
<body>
  ...
  <div class="header">
    <a href="/index.html" class="logo">
     ...
     <ul class="navbar">
            <li><a href="facultyHome">Dashboard</a></li>
...
<!-- header -->
  ...
  <div class="total-login">
    ...
    <div class="login-wrapper">
      ...
      <form class="form" action="insertMaterialFile" method="post" enctype="multipart/form-data" >
    ...
    background: transparent;"type="text" name="description" id="loginPassword" required="required" placeholder="Enter Material Description Here."></textarea>
	          
	        </div>
	        <div class="input-group">
	          <input type="file" name="file" id="loginPassword" required="required">
